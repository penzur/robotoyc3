...
This project is written in Rust for embedded systems. If you're new to embedded Rust,
read [**The Embedded Rust Book**](https://doc.rust-lang.org/embedded-book/intro/index.html) first. 
It covers toolchain setup, cross-compilation, and flashing workflow.
